...
pub fn decode_event_json(event_type: &str, bcs_data: &[u8]) -> Option<String> {
    match event_type {
        "OrderPlaced" => {
            decode_deepbook_event("OrderPlaced", bcs_data, |ev: MoveOrderPlacedEvent| {
                json!({
        ...
        "OrderModified" => {
            decode_deepbook_event("OrderModified", bcs_data, |ev: MoveOrderModifiedEvent| {
                json!({
        ...
        "OrderCanceled" => {
            decode_deepbook_event("OrderCanceled", bcs_data, |ev: MoveOrderCanceledEvent| {
                json!({
        ...
        "OrderExpired" => {
            decode_deepbook_event("OrderExpired", bcs_data, |ev: MoveOrderExpiredEvent| {
                json!({
        ...
        "OrderFilled" => {
            decode_deepbook_event("OrderFilled", bcs_data, |ev: MoveOrderFilledEvent| {
                json!({
        ...
        "FlashLoanBorrowed" => decode_deepbook_event(
            "FlashLoanBorrowed",
            bcs_data,
            |ev: MoveFlashLoanBorrowedEvent| {
                json!({
        ...
        "BalanceEvent" => {
            decode_deepbook_event("BalanceEvent", bcs_data, |ev: MoveBalanceEvent| {
                json!({
        ...
        "ProposalEvent" => {
            decode_deepbook_event("ProposalEvent", bcs_data, |ev: MoveProposalEvent| {
                json!({
        ...
        "TradeParamsUpdateEvent" => decode_deepbook_event(
